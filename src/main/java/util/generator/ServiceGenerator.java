...
public class ServiceGenerator extends BasicGenerator {
    ...
    public static List<String> classStart() {
        ...
        if(isServiceImpl){
            ...
            list.add("public class %sService {",entityName);
        }
        list.add(1,"@Autowired");
        list.add(1,"%sMapper %sMapper;",entityName,entityName_camel);
        return list.getArrayList();
    }
    public static List<String> content_simple() {
    ...
    public static List<String> content_impl() {
        List<String> list = new ArrayList();
    ...
    public static void main(String[] args) {
        List<String> content = content_simple();
